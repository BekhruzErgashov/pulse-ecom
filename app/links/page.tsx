...
// /my-tasks: определяем нужное пространство (из cookie, иначе первое
// доступное) и уводим на /w/[id]/links.
export default async function LinksRedirectPage() {
