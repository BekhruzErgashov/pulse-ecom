...
// /my-tasks без ID пространства — тот же приём, что и в /boards, /questions:
// определяем нужное пространство (из cookie, иначе первое доступное) и
// уводим на /w/[id]/my-tasks.
