...
export interface Task {
  ...
  /** Когда исполнителю/постановщику в последний раз напомнили проверить задачу на этапе «На проверке». Нужна, чтобы напоминание уходило раз в сутки независимо от частоты запуска cron. */
