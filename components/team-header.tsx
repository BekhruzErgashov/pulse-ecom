...
export function TeamHeader({
  ...
  const isDarkGlass = theme === "dark-glass";
  ...
  return (
    <header className="app-header relative z-30 border-b border-[var(--color-line)] bg-[var(--color-paper-raised)]/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-3">
        ...
        <nav className="nav-pill flex items-center gap-1 rounded-full border border-[var(--color-line)] bg-[var(--color-paper)] p-1">
          {NAV_LINKS.map((link) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "bg-[var(--color-signal)] text-white shadow-sm"
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem onClick={() => setTheme(isDarkGlass ? "light" : "dark-glass")}>
                {isDarkGlass ? (
                  <>
